          ...
          <>
            ...
            {showVideoModal && (
              <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,.88)", backdropFilter:"blur(12px)", display:"flex", alignItems:"center", justifyContent:"center", zIndex:300 }}
                ...
                <div style={{ position:"relative", width:"90vw", maxWidth:900, borderRadius:10, overflow:"hidden", border:"1px solid rgba(201,168,76,.12)", boxShadow:"0 40px 80px rgba(0,0,0,.8)" }}>
